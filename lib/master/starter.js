...
starter.run = function(app, server, cb) {
  ...
  if (utils.isLocal(server.host)) {
    ...
    //options > ["/Users/sdev/Desktop/nodejs/pomelo/template/game-server/app.js","env=development","id=connector-server-1","host=127.0.0.1","port=3150","clientHost=127.0.0.1","clientPort=3010","frontend=true","serverType=connector"]
